      ...
      <div className="mx-auto max-w-6xl px-6 w-full grid lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-7">
          ...
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.2 }}
            ...
            5+ years of <span className="text-white">full-stack engineering</span> across SAP Labs, Aviva and Zoho — now building <span className="text-white">agentic AI</span> in production.
          </motion.p>
